...
|};
/**
 * The BlocklyToolbox container is responsible to parse
 * the activity configuration for Blocky and generate
 * a correct XML representation which will be required
 * for the instanciation of the Blockly workspace.
 *
 * @todo Add example
 * @version 1.0.0
 */
export default class BlocklyToolbox extends React.Component {
  ...
  render() {
    ...
    return (
      <xml ref={(toolbox: HTMLElement) => this.toolbox = toolbox} style={{ display: 'none' }}>

...
import staticNumberGenerator from '../staticNumberGenerator';
import lineEmotionsBuilder from '../functionalities/lineEmotionsBuilder';
import receiveNumberAtPositionBuilder from '../functionalities/receiveNumberAtPositionBuilder';
...
const lineGenerator = (
  ...
  return componentGenerator(view, size, margin)
    .addFunctionality('emotions', lineEmotionsBuilder(staticNumbers))
    .addFunctionality('receiveNumberAtPosition', receiveNumberAtPositionBuilder)
    .build();
};
